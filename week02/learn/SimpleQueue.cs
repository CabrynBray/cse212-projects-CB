public class SimpleQueue
{
    public static void Run()
    {
        ...
        // Defect(s) Found: Trying to remove a value that in not their.
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: The enqueue was inserting them in the wrrong order, this means that the Dequeue was removing the wrrong ones. 
